...
import logo from "./assets/cazton.png";
    ...
    return (
        <div className="flex min-h-screen flex-col bg-gray-100 text-gray-900">
            ...
            <div className="flex justify-center p-4">
                {" "}
                <img src={logo} alt="Cazton logo" className="h-10 w-auto"/>
            </div>
            ...
            <footer className="py-4 text-center">
                <p>Built with Azure Cosmos DB NoSQL API (supports DiskANN and Quantized Flat) + Azure OpenAI</p>
            </footer>
